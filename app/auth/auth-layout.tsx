  ...
  return (
    <main className="flex flex-col md:flex-row gap-3 min-h-screen">
      <section className="flex justify-center md:items-center md:p-8 md:w-1/2 md:min-h-full">
        <div className="w-full h-full bg-gray-50 rounded-3xl md:px-5 md:py-32">
          <Image
            src={placeholderImg}
      ...
      <section className="p-6 md:p-16 xl:p-32 bg-white shadow-md md:shadow-none rounded-t-[34px] md:h-full md:w-1/2">
        {children}
      </section>
    </main>
  );
